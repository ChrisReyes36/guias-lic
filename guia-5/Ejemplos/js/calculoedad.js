...
function iniciar() {
    ...
    if (btncalcular.addEventListener) {
        btncalcular.addEventListener(
            ...
            function () {
                dia =
                    document.frmFechaNac.seldia.options[
                        frmFechaNac.seldia.selectedIndex
                    ].value;
                mes =
                    document.frmFechaNac.selmes.options[
                        frmFechaNac.selmes.selectedIndex
                    ].value;
    ...
    if (selmes.addEventListener) {
        selmes.addEventListener(
            "change",
            function () {
                mes =
                    document.frmFechaNac.selmes.options[
                        document.frmFechaNac.selmes.selectedIndex
                    ].value;
